<?php
  ...
  function educash_payment($atts,$content = null)
  {
      if(is_user_logged_in())
      {
        ...
        <form name="tranaction_form" ng-app="myApp" ng-init="amount=0" ng-controller="personCtrl" method="post" action="">
          <div class="pay_card"  style="background-image: url("<?php echo $background;?>");">
            <div class ="pay_card2">
              ...
              <div class="pay_inputbox1"><input  ng-model="amount" type="number" name="amount" placeholder="0" style="font-size: 20pt; text-align: center; font-weight: bold;" maxlength="10" required/></div>
