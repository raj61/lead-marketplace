<?php
  ...
  function educash_payment($atts,$content = null)
  {
      if(is_user_logged_in())
      {
        ...
        <form name="tranaction_form" ng-app="myApp" ng-controller="personCtrl" method="post" action="">
          <div class="pay_card"  style="background-image: url("<?php echo $background;?>");">
            <div class ="pay_card2">
              ...
              <div class="pay_output_amount"><b>Total =  {{fullamount()*<?php echo $conversion; ?>}} Rs. </b></div>
       ...
       <div class="pay_card" >
         <div class ="pay_card2">
             ...
             <div class="pay_output_amount"><b>Total =  {{fullamount()*<?php echo $conversion_karmas; ?>}} karmas. </b></div>
